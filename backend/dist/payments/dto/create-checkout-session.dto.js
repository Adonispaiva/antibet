...
__decorate([
    (0, class_validator_1.IsUUID)('4', { message: 'O ID do plano (planId) deve ser um UUID valido.' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'O ID do plano (planId) e obrigatorio.' }),
