...
import 'packagepackage:antibet/features/journal/providers/journal_provider.dart';
import 'package:calendar_timeline/calendar_timeline.dart';
import 'packagepackage:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'packagepackage:intl/intl.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          // TODO: Implementar navegação para Adicionar Aposta
        },
  ...
  Widget _buildJournalContent(JournalState state) {
    return state.when(
      ...
      loaded: (journal) {
        ...
        return JournalStats(journal: journal);
      },
      error: (message) {
        // Se deu erro, exibe uma mensagem
        // (O SnackBar também será exibido pelo 'ref.listen')
        return Center(
          child: Padding(
